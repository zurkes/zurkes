...
# ==== Eğitim döngüsü ====
# Güvenli optimizasyon: validation frequency
val_frequency = 3  # Her 3 epoch'ta bir validation
...
for e in range(start_epoch, int(cfg["training"]["epochs"]) + 1):
    ...
    # en iyi model kaydı
    # Smart checkpoint: sadece improvement varsa veya belirli aralıklarda
    if (e % val_frequency == 0 and val_miou > best_miou) or e % 10 == 0:
        best_miou = val_miou
